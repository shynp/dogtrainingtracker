...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            int childWidthPass = MeasureSpec.makeMeasureSpec(sizeWidth, modeWidth == MeasureSpec.EXACTLY ? MeasureSpec.AT_MOST : modeWidth);
            int childHeightPass = MeasureSpec.makeMeasureSpec(lp.height, modeHeight == MeasureSpec.EXACTLY ? MeasureSpec.AT_MOST : modeHeight);
            child.measure(childWidthPass, childHeightPass);
            Log.i("TAG","Child width: " + MeasureSpec.getSize(childWidthPass));
            Log.i("TAG","Child height: " + MeasureSpec.getSize(childHeightPass));
            ...
            int childHeight = lp2.height;
            Log.i("TAG",lp2.height + "");
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            child.layout(lp.x, lp.y, lp.x + child.getMeasuredWidth(), lp.y + lp.height);
        }
    }
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        {
        	this.horizontalSpacing = h;
        	this.verticalSpacing = v;
        }
